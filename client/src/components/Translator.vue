        ...
        <div class="container h-[100vh] mx-auto px-4 relative">
            ...
            <div class="flex justify-between gap-5">
                ...
                <div class="w-1/2 p-10 border-[1px] border-white rounded-[50px] h-[75vh]">
                    <div class="flex items-center">
                        <label for="targetVoice" class="block text-base font-poppins pr-2 text-white">Target Voice
                        </label>
                        <select id="targetVoice" v-model="targetVoice" class=" font-poppins border rounded">
                            <option v-for="voice in filteredVoices" :value="voice.voice_code">{{ voice.language_name
                                }}-{{
                                    voice.voice_gender }}-{{ voice.voice_type }}
                            </option>
                        </select>
                    </div>
...
export default {
        ...
        return {
            ...
            voices:
                [
                    ...
                    {
                        "language_code": "am-ET",
                        "language_name": "Amharic (Ethiopia)",
                        "voice_type": "Neural",
                        "voice_code": "am-ET-1",
                        "voice_gender": "Male"
                    },
                    ...
                    {
                        "language_code": "bn-BD",
                        "language_name": "Bangla (Bangladesh)",
                        "voice_type": "Neural",
                        "voice_code": "bn-BD-1",
                        "voice_gender": "Female"
                    },
                    ...
                    {
                        "language_code": "en-HK",
                        "language_name": "English (Hongkong)",
                        "voice_type": "Neural",
                        "voice_code": "en-HK-1",
                        "voice_gender": "Male"
                    },
                    ...
                    {
                        "language_code": "en-TZ",
                        "language_name": "English (Tanzania)",
                        "voice_type": "Neural",
                        "voice_code": "en-TZ-1",
                        "voice_gender": "Male"
                    },
                    ...
                    {
                        "language_code": "es-CR",
                        "language_name": "Spanish (Costa Rica)",
                        "voice_type": "Neural",
                        "voice_code": "es-CR-1",
                        "voice_gender": "Male"
                    },
                    ...
                    {
                        "language_code": "es-DO",
                        "language_name": "Spanish (Dominican Republic)",
                        "voice_type": "Neural",
                        "voice_code": "es-DO-1",
                        "voice_gender": "Male"
                    },
                    ...
                    {
                        "language_code": "es-GQ",
                        "language_name": "Spanish (Equatorial Guinea)",
                        "voice_type": "Neural",
                        "voice_code": "es-GQ-1",
                        "voice_gender": "Male"
                    },
                    ...
                    {
                        "language_code": "es-HN",
                        "language_name": "Spanish (Honduras)",
                        "voice_type": "Neural",
                        "voice_code": "es-HN-1",
                        "voice_gender": "Male"
                    },
                    ...
                    {
                        "language_code": "es-NI",
                        "language_name": "Spanish (Nicaragua)",
                        "voice_type": "Neural",
                        "voice_code": "es-NI-1",
                        "voice_gender": "Male"
                    },
                    ...
                    {
                        "language_code": "es-SV",
                        "language_name": "Spanish (El Salvador)",
                        "voice_type": "Neural",
                        "voice_code": "es-SV-1",
                        "voice_gender": "Female"
                    },
                    ...
                    {
                        "language_code": "es-VE",
                        "language_name": "Spanish (Venezuela)",
                        "voice_type": "Neural",
                        "voice_code": "es-VE-1",
                        "voice_gender": "Female"
                    },
                    ...
                    },
                    {
                        ...
                        "language_name": "Filipino (Philippines)",
                        "voice_type": "Neural",
                        "voice_code": "fil-PH-1",
                        "voice_gender": "Male"
                    },
                    ...
                    {
                        "language_code": "fr-CH",
                        "language_name": "French (Switzerland)",
                        "voice_type": "Neural",
                        "voice_code": "fr-CH-1",
                        "voice_gender": "Female"
                    },
                    ...
                    {
                        "language_code": "jv-ID",
                        "language_name": "Javanese (Indonesia)",
                        "voice_type": "Neural",
                        "voice_code": "jv-ID-1",
                        "voice_gender": "Male"
                    },
                    ...
                    {
                        "language_code": "su-ID",
                        "language_name": "Sundanese (Indonesia)",
                        "voice_type": "Neural",
                        "voice_code": "su-ID-1",
                        "voice_gender": "Male"
                    },
                    ...
                    {
                        "language_code": "zh-HK",
                        "language_name": "Chinese (Cantonese, Traditional)",
                        "voice_type": "Neural",
                        "voice_code": "zh-HK-1",
                        "voice_gender": "Female"
                    },
                    ...
                    {
                        "language_code": "zh-TW",
                        "language_name": "Chinese (Taiwanese Mandarin)",
                        "voice_type": "Neural",
                        "voice_code": "zh-TW-1",
                        "voice_gender": "Female"
                    },
    ...
    computed: {
        filteredVoices() {
            return this.voices.filter(voice => voice.language_code.startsWith(this.targetLanguage));
        }
    },
    methods: {
        async pronounce() {
            const encodedParams = new URLSearchParams();
            encodedParams.set('voice_code', this.targetVoice);
            encodedParams.set('text', this.outputData);
            ...
            try {
                ...
                console.error(error);
                alert("Please verify the text input.")
            }
        },
        async translate() {
            if (this.sourceLanguage && this.targetLanguage && this.targetVoice && this.inputData && this.sourceLanguage !== this.targetLanguage) {
                const encodedParams = new URLSearchParams();
        ...
        toggleRecognition() {
            if (this.sourceLanguage && this.targetLanguage && this.targetVoice && this.sourceLanguage !== this.targetLanguage) {
